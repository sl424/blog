...
if (CloudflareApps.matchPage(CloudflareApps.installs['44pJfF7Ly0NK'].URLPatterns)) {
...
var options = CloudflareApps.installs['44pJfF7Ly0NK'].options;
var element = void 0;
...
window.CloudflareApps.installs['44pJfF7Ly0NK'].scope = {
...
if (CloudflareApps.matchPage(CloudflareApps.installs['KuhDEr18HlCg'].URLPatterns)) {
(function (modules) {
...
var options = CloudflareApps.installs['KuhDEr18HlCg'].options
var element = void 0
var textContainer = void 0
var observer = void 0
var opacityTimeout = void 0
var target = void 0
...
var offsetTop = getOffsetTop(element) - document.documentElement.clientHeight
var currentY = Math.max(document.body.scrollTop - offsetTop, 0)
...
minutes = _getTextEstimates.minutes,
wordCount = _getTextEstimates.wordCount
...
function updateElement() {
element = CloudflareApps.createElement(element, element)
...
return document.querySelector(selector) && bootstrap()
})
...
window.CloudflareApps.installs['KuhDEr18HlCg'].scope = {
